...
export const Icons = {
    ...
    vnd: (props: IconProps) => (
        ...
        >
            ...
            >
                ...
                />
                <path
                    d="M 54.784 30.841 h -1.688 V 25 c 0 -1.657 -1.343 -3 -3 -3 s -3 1.343 -3 3 v 5.841 h -4.079 c -1.657 0 -3 1.343 -3 3 s 1.343 3 3 3 h 4.079 v 2.799 l -4.079 0.015 c -5.956 0 -10.801 4.845 -10.801 10.801 s 4.845 10.802 10.801 10.802 h 7.079 c 1.657 0 3 -1.343 3 -3 V 36.841 h 1.688 c 1.657 0 3 -1.343 3 -3 S 56.442 30.841 54.784 30.841 z M 38.216 50.457 c 0 -2.647 2.154 -4.801 4.813 -4.801 l 4.068 -0.015 v 9.618 h -4.079 C 40.369 55.259 38.216 53.104 38.216 50.457 z"
                    style={{
                        stroke: "none",
                        strokeWidth: 1,
                        strokeDasharray: "none",
                ...
                />
                <path
                    d="M 50.096 64 h -14.88 c -1.657 0 -3 1.343 -3 3 s 1.343 3 3 3 h 14.88 c 1.657 0 3 -1.343 3 -3 S 51.753 64 50.096 64 z"
                    style={{
                        stroke: "none",
                        strokeWidth: 1,
                        strokeDasharray: "none",
                ...
                />
                <path
                    d="M 54.784 26.841 h -1.688 V 21 c 0 -1.657 -1.343 -3 -3 -3 s -3 1.343 -3 3 v 5.841 h -4.079 c -1.657 0 -3 1.343 -3 3 s 1.343 3 3 3 h 4.079 v 2.799 l -4.079 0.015 c -5.956 0 -10.801 4.845 -10.801 10.801 s 4.845 10.802 10.801 10.802 h 7.079 c 1.657 0 3 -1.343 3 -3 V 32.841 h 1.688 c 1.657 0 3 -1.343 3 -3 S 56.442 26.841 54.784 26.841 z M 38.216 46.457 c 0 -2.647 2.154 -4.801 4.813 -4.801 l 4.068 -0.015 v 9.618 h -4.079 C 40.369 51.259 38.216 49.104 38.216 46.457 z"
                    style={{
                        stroke: "none",
                        strokeWidth: 1,
                        strokeDasharray: "none",
                ...
                />
                <path
                    d="M 50.096 60 h -14.88 c -1.657 0 -3 1.343 -3 3 s 1.343 3 3 3 h 14.88 c 1.657 0 3 -1.343 3 -3 S 51.753 60 50.096 60 z"
                    style={{
                        stroke: "none",
                        strokeWidth: 1,
                        strokeDasharray: "none",
            ...
            <defs>
                <style
                    dangerouslySetInnerHTML={{
                        __html: ".cls-1,.cls-4{fill:#005baa;}.cls-2,.cls-5{fill:#ed1c24;}.cls-3{fill:#009edb;}.cls-4,.cls-5{fill-rule:evenodd;}",
                    }}
                />
            </defs>
            <path
    ...
    cod: (props: IconProps) => (
        <svg viewBox="0 0 64 64" {...props} xmlns="http://www.w3.org/2000/svg">
            <g
                id="Cash_On_Delivery-Cod-Ecommerce-Payment--Shopping"
                data-name="Cash On Delivery-Cod-Ecommerce-Payment--Shopping"
            >
                <path d="m3 16v26h40v-16-10z" fill="#d1d3d4" />
                <path
                    d="m56 28v8h-6v-10h4a2.006 2.006 0 0 1 2 2z"
                    fill="#e6e7e8"
                />
                <path d="m3 42h40v8h-40z" fill="#ff9811" />
                <path d="m61 39v11h-18v-8-16h7v10h6v.14z" fill="#ff9811" />
                <circle cx={11} cy={50} fill="#57565c" r={4} />
                <circle cx={20} cy={50} fill="#57565c" r={4} />
                <circle cx={53} cy={50} fill="#57565c" r={4} />
                <path d="m57 41h4v4h-4z" fill="#ffc477" />
                <path d="m50 39h4v2h-4z" fill="#ee8700" />
                <path d="m2 54h60v2h-60z" fill="#57565c" />
                <g fill="#ff9811">
                ...
                <path
                    d="m23 34h-1a3 3 0 0 1 -3-3v-4a3 3 0 0 1 3-3h1a3 3 0 0 1 3 3v4a3 3 0 0 1 -3 3zm-1-8a1 1 0 0 0 -1 1v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-4a1 1 0 0 0 -1-1z"
                    fill="#ee8700"
                />
                <path
                    d="m32 34h-3a1 1 0 0 1 -1-1v-8a1 1 0 0 1 1-1h3a3 3 0 0 1 3 3v4a3 3 0 0 1 -3 3zm-2-2h2a1 1 0 0 0 1-1v-4a1 1 0 0 0 -1-1h-2z"
                    fill="#ee8700"
                />
                <path
                    d="m14 34h-1a3 3 0 0 1 -3-3v-4a3 3 0 0 1 3-3h1a3 3 0 0 1 3 3h-2a1 1 0 0 0 -1-1h-1a1 1 0 0 0 -1 1v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1h2a3 3 0 0 1 -3 3z"
                    fill="#ee8700"
                />
                <path d="m10 49h2v2h-2z" fill="#3e3d42" />
                <path d="m19 49h2v2h-2z" fill="#3e3d42" />
                <path d="m52 49h2v2h-2z" fill="#3e3d42" />
            </g>
        </svg>
    ),
};
